...
Instead of trying to rehash the talk, I’m publishing my notes and highlights from the keynote that
drew my attention.
...
a highly uncurated dataset and you’ll have noise or wrong data in the output of the NLP processing
